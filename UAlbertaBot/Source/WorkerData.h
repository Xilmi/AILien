...
public:
	...
	int						getGeysersNearDepot(BWAPI::Unit depot, bool refinery = false);
	int						getWorkersNearDepot(BWAPI::Unit depot);
	int						getEnemyStrenghtNearDepot(BWAPI::Unit depot);
	...
	int                     getNumDepots(bool gas = false, bool onlyfinished = false);
